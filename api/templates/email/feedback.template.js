...
const subject_mail = "Website Feedback Received";

const message = (name, email, messageContent, rating) => {
  return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                                ...
                                <tr>
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" width="540" align="center" style="padding: 0;">
                                            <tr>
                                                <td style="font-size: 19px; color: #cc3625; font-weight: 600; font-family: 'Open Sans', sans-serif; line-height: 18px;">Dear Support Team,</td>
                                            </tr>
                                            <tr>
                                                <td align="left" valign="top" style="font-family: 'Gotham Book', sans-serif; font-size: 16px; color: #000000; line-height: 20px;">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 17px; color: #69737c; font-weight: 400; font-family: 'Open Sans', sans-serif; line-height: 22px;">A new feedback has been submitted by a customer.</td>
                                            </tr>
                                            <tr>
                                                <td align="left" valign="top" style="font-family: 'Gotham Book', sans-serif; font-size: 16px; color: #000000; line-height: 20px;">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 17px; color: #69737c; font-weight: 400; font-family: 'Open Sans', sans-serif; line-height: 22px;">Name: ${name}</td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 17px; color: #69737c; font-weight: 400; font-family: 'Open Sans', sans-serif; line-height: 22px;">Email: ${email}</td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 17px; color: #69737c; font-weight: 400; font-family: 'Open Sans', sans-serif; line-height: 22px;">Message: ${messageContent}</td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 17px; color: #69737c; font-weight: 400; font-family: 'Open Sans', sans-serif; line-height: 22px;">Rating: ${rating} / 5</td>
                                            </tr>
                                            <tr>
                                                <td align="left" valign="top" style="font-family: 'Gotham Book', sans-serif; font-size: 16px; color: #000000; line-height: 20px;">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 17px; color: #69737c; font-weight: 400; font-family: 'Open Sans', sans-serif; line-height: 22px;">Please respond to the user's feedback promptly.</td>
                                            </tr>
                                            <tr>
                                                <td align="left" valign="top" style="font-family: 'Gotham Book', sans-serif; font-size: 16px; color: #000000; line-height: 20px;">&nbsp;</td>
                                            </tr>
