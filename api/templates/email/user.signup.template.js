...
const subject_mail = "Account Created: Welcome to entertainam.com";
                                  ...
                                  <tr>
                                      <td>
                                          <table border="0" cellpadding="0" cellspacing="0" width="540" align="center" style="padding: 0;">
                                              ...
                                              <tr>
                                                  <td style="font-size: 17px; color: #69737c; font-weight: 400; font-family: 'Open Sans', sans-serif; line-height: 22px;">Congratulations! Your account has been successfully created. You can now log in to <a href="https://beta.entertainam.com"> entertainam.com</a>  using your registered mobile number.</td>
                                              </tr>
                                              <tr>
                                                  <td align="left" valign="top" style="font-family: 'Gotham Book', sans-serif; font-size: 16px; color: #000000; line-height: 20px;">&nbsp;</td>
                                              </tr>
