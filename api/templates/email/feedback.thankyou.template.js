...
const subject_mail = "Thank You for Your Feedback";
                                ...
                                <tr>
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" width="540" align="center" style="padding: 0;">
                                            <tr>
                                                <td style="font-size: 19px; color: #cc3625; font-weight: 600; font-family: 'Open Sans', sans-serif; line-height: 18px;">Dear ${name},</td>
                                            </tr>
                                            <tr>
                                                <td align="left" valign="top" style="font-family: 'Gotham Book', sans-serif; font-size: 16px; color: #000000; line-height: 20px;">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 17px; color: #69737c; font-weight: 400; font-family: 'Open Sans', sans-serif; line-height: 22px;">Thank you for your feedback!</td>
                                            </tr>
                                            <tr>
                                                <td align="left" valign="top" style="font-family: 'Gotham Book', sans-serif; font-size: 16px; color: #000000; line-height: 20px;">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 17px; color: #69737c; font-weight: 400; font-family: 'Open Sans', sans-serif; line-height: 22px;">We appreciate you taking the time to share your thoughts with us. Your feedback is invaluable in helping us improve our services and deliver the best possible experience for our users.</td>
                                            </tr>
                                            <tr>
                                                <td align="left" valign="top" style="font-family: 'Gotham Book', sans-serif; font-size: 16px; color: #000000; line-height: 20px;">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 17px; color: #69737c; font-weight: 400; font-family: 'Open Sans', sans-serif; line-height: 22px;">If you have any further comments or questions, please do not hesitate to reach out to us at any time.</td>
                                            </tr>
                                            <tr>
                                                <td align="left" valign="top" style="font-family: 'Gotham Book', sans-serif; font-size: 16px; color: #000000; line-height: 20px;">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 20px; color: #cc3625; font-weight: 600; font-family: 'Open Sans', sans-serif; line-height: 22px;">Best regards,</td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 17px; color: #69737c; font-weight: 400; font-family: 'Open Sans', sans-serif; line-height: 22px;">The Entertainam Team</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
...
module.exports = { subject_mail, thankYouMessage };
