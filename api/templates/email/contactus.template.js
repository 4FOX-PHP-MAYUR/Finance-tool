...
const subject_mail = "Contact Us Request";

const message = (name, email, messageContent) => {
      return `<!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
                                ...
                                <table width="100%" align="center" style="border-collapse: collapse !important; padding: 0 !important;">
                                    <tr>
                                        ...
                                        <td align="left" valign="top" style="font-family: 'Gotham Book', sans-serif; font-size: 16px; color: #000000; line-height: 20px;">&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td style="font-size: 17px; color: #69737c; font-weight: 400; font-family: 'Open Sans', sans-serif; line-height: 22px;">A new contact request has been submitted.</td>
                                                </tr>
                                                <tr>
                                        <td align="left" valign="top" style="font-family: 'Gotham Book', sans-serif; font-size: 16px; color: #000000; line-height: 20px;">&nbsp;</td>
                                    </tr>
                                        ...
                                        <td align="left" valign="top" style="font-family: 'Gotham Book', sans-serif; font-size: 16px; color: #000000; line-height: 20px;">&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td style="font-size: 17px; color: #69737c; font-weight: 400; font-family: 'Open Sans', sans-serif; line-height: 22px;">Please respond to the user's inquiry promptly.</td>
