...
const subject_mail = "MPIN Added Successfully";
...
const message = (username) => {
  ...
  <head>
      ...
      <title>MPIN Added Successfully</title>
      <style type="text/css">
                                  ...
                                  <tr>
                                      <td>
                                          <table border="0" cellpadding="0" cellspacing="0" width="540" align="center" style="padding: 0;">
                                              ...
                                              <tr>
                                                  <td style="font-size: 17px; color: #69737c; font-weight: 400; font-family: 'Open Sans', sans-serif; line-height: 22px;">Congratulations! Your MPIN has been successfully added to your account. You can now use your MPIN to access your account securely on <a href="https://beta.entertainam.com">entertainam.com</a>.</td>
                                              </tr>
                                              <tr>
                                                  <td align="left" valign="top" style="font-family: 'Gotham Book', sans-serif; font-size: 16px; color: #000000; line-height: 20px;">&nbsp;</td>
                                              </tr>
