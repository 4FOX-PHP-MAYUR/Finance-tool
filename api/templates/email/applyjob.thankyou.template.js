...
const subject_mail = "Thank You for Contacting Us";
                                    ...
                                    <tr>
                                        <td>
                                            <table border="0" cellpadding="0" cellspacing="0" width="540" align="center" style="padding: 0;">
                                                ...
                                                <tr>
                                                    <td style="font-size: 17px; color: #69737c; font-weight: 400; font-family: 'Open Sans', sans-serif; line-height: 22px;">Thank you for applying for the position at entertainam.com.</td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size: 17px; color: #69737c; font-weight: 400; font-family: 'Open Sans', sans-serif; line-height: 22px;">We have received your application and will review it carefully.</td>
                                                </tr>
                                                <tr>
                                                    <td align="left" valign="top" style="font-family: 'Gotham Book', sans-serif; font-size: 16px; color: #000000; line-height: 15px;">&nbsp;</td>
                                                </tr>
                        ...
                        <tr>
                            <td>
                                <table width="420" align="center">
                                    <tr>
                                        <td align="right" style="font-size: 12px; color: #fff; font-weight: 400; font-family: 'Open Sans', sans-serif; line-height: 18px;">©2024 All Rights Reserved</td>
